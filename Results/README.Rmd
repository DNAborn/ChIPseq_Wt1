...
```{r method_overview2, echo = TRUE, include=FALSE, results='markup'}
...
#  ht_list[[run]] <-  hist_hits[[run]] / gridExtra::tableGrob(table, theme = t1) +  plot_layout(heights = c(1,2))
  ht_list[[run]] <-  (hist_hits[[run]] + g) / (g2 + gridExtra::tableGrob(table, theme = t1)) + plot_layout(widths = 1)
...
ht_list[[1]]
wrap_plots(ht_list[1])
(hist_hits[[1]] + g) / (g2 + gridExtra::tableGrob(table, theme = t1))
