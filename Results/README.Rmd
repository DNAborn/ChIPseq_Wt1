...
#### Hists & Tables
```{r hits_tables, echo=FALSE, results = "show", fig.width=12, out.width="100%"}
...
paste("Method: ",run)
plot(g1+g4+g2+g3+plot_layout(guides = "collect", axis_titles="collect"))
...
## Annotate Peaks
#### 1 Run
```{r annotated_peaks, fig.width=12, include=TRUE, results="show", out.width="100%"}
...
#### All runs old2
```{r annotae_all_peaks_old2, fig.width=12, out.width="100%"}
