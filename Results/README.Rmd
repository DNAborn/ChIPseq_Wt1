...
#### Peak Tables
```{r peak_numbers, echo=TRUE, message=TRUE, warning=TRUE, paged.print=TRUE}
...
#### Hists & Tables
```{r hits_tables, echo=FALSE, fig.height=8}
# fig.height=10, fig.width=10, out.height="2000px", out.width="100%"
...
score_lim <- quantile(df$score, .95)
signalValue_lim <- quantile(df$signalValue, .95)
